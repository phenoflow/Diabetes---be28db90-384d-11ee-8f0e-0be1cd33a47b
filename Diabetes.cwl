...
steps:
  read-potential-cases-omop:
    ...
    in:
      inputModule:
        id: inputModule
        source: inputModule1
  antidiabetic-diabetes---primary:
    run: antidiabetic-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-malnutritionrelated---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: antidiabetic-diabetes---primary/output
  diabetes-background---primary:
    run: diabetes-background---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-prolif---primary:
    run: diabetes-prolif---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-background---primary/output
  moderate-diabetes---primary:
    run: moderate-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-ulcerated---primary:
    run: diabetes-ulcerated---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-ulcerated---primary/output
  diabetes-screening---primary:
    run: diabetes-screening---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  dietary-diabetes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-screening---primary/output
  diabetes-injection---primary:
    run: diabetes-injection---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  stable-diabetes---primary:
    run: stable-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  patient-diabetes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: stable-diabetes---primary/output
  diabetes-programme---primary:
    run: diabetes-programme---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-shared---primary:
    run: diabetes-shared---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-programme---primary/output
  unsuitable-diabetes---primary:
    run: unsuitable-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-shared---primary/output
  annual-diabetes---primary:
    run: annual-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: unsuitable-diabetes---primary/output
  diabetes-blood---primary:
    run: diabetes-blood---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-assessment---primary:
    run: diabetes-assessment---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-blood---primary/output
  ...
  diabetes-examination---primary:
    run: diabetes-examination---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-needle---primary:
    run: diabetes-needle---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-month---primary:
    run: diabetes-month---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-changed---primary:
    run: diabetes-changed---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-review---primary:
    run: diabetes-review---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  noninsulindependent-diabetes---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-review---primary/output
  subcutaneous-diabetes---primary:
    run: subcutaneous-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-erectile---primary:
    run: diabetes-erectile---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: subcutaneous-diabetes---primary/output
  diabetes-counselling---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-erectile---primary/output
  diabetes-advice---primary:
    run: diabetes-advice---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-offered---primary:
    run: diabetes-offered---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-advice---primary/output
  digital-diabetes---primary:
    run: digital-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  painful-diabetes---primary:
    run: painful-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-therapy---primary:
    run: diabetes-therapy---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  advanced-diabetes---primary:
    run: advanced-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-therapy---primary/output
  diabetes-record---primary:
    run: diabetes-record---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: advanced-diabetes---primary/output
  diabetes-mellitus---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-record---primary/output
  ...
  neurological-diabetes---primary:
    run: neurological-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-amyotrophy---primary:
    run: diabetes-amyotrophy---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  neuropathy-diabetes---primary:
    run: neuropathy-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-amyotrophy---primary/output
  diabetes-circulatory---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: neuropathy-diabetes---primary/output
  ...
  exudative-diabetes---primary:
    run: exudative-diabetes---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mononeuritis---primary:
    run: diabetes-mononeuritis---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-lipohypertrophy---primary:
    run: diabetes-lipohypertrophy---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-agent---primary:
    run: diabetes-agent---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-lipohypertrophy---primary/output
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-agent---primary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
